...
setup(
    ...
    url='https://github.com/quiksand/anasys-python-tools',
    ...
    keywords='microscopy microscope Anasys Instruments AFM ssnom s-snom axz axd .axz .axd atomic force microscope hyperspectral spectra spectrum infrared spectroscopy',
